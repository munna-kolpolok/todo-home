...
class CreateItemCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Item_categories", 'item_categories', 'item_cat_name', 'fa-angle-double-right', [
            ["item_cat_name", "Category Name", "String", true, "", 0, 256, true],
            ["item_cat_code", "Category Code", "String", false, "", 0, 10, false],
        ]);
