...
class CreateAcademyCoursesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Academy_courses", 'academy_courses', 'academy_course_name', 'fa-angle-double-right', [
            ["academy_course_name", "Name", "TextField", false, "", 0, 256, true],
        ]);
