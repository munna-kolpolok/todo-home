...
class CreateVehicleTypesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Vehicle_types", 'vehicle_types', 'vehicle_type', 'fa-angle-double-right', [
            ["vehicle_type", "Vehicle Type", "String", false, "", 0, 256, true],
            ["vehicle_type_code", "Short Name", "String", false, "", 0, 20, false],
        ]);
