...
class CreateTrainingTypesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Training_types", 'training_types', 'training_type', 'fa-angle-double-right', [
            ["training_type", "Training Type", "String", true, "", 0, 256, true],
            ["ttype_short_code", "Short Code", "String", false, "", 0, 10, false],
        ]);
