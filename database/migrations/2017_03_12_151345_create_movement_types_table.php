...
class CreateMovementTypesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Movement_types", 'movement_types', 'movement_type', 'fa-angle-double-right', [
            ["movement_type", "Movement Type", "String", true, "", 0, 256, true],
            ["mtype_short_code", "Short Code", "String", false, "", 0, 10, false],
        ]);
