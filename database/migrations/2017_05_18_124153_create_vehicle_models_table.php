...
class CreateVehicleModelsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Vehicle_models", 'vehicle_models', 'model_name', 'fa-angle-double-right', [
            ["brand_id", "Brand", "Dropdown", false, "", 0, 0, true, "@vehicle_brands"],
            ["model_name", "Model", "TextField", false, "", 0, 100, true],
        ]);
