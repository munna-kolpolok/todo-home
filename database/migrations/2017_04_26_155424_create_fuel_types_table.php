...
class CreateFuelTypesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Fuel_types", 'fuel_types', 'fuel_type', 'fa-angle-double-right', [
            ["fuel_type", "Type", "TextField", true, "", 0, 256, true],
            ["fuel_munit", "Measurement Unit", "TextField", false, "", 0, 256, true],
        ]);
