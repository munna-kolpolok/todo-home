...
class CreateVehicleBrandsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Vehicle_brands", 'vehicle_brands', 'vehicle_brand_name', 'fa-angle-double-right', [
            ["vehicle_brand_name", "Brand Name", "String", false, "", 0, 256, true],
            ["vehicle_brand_code", "Short Name", "String", false, "", 0, 20, false],
        ]);
