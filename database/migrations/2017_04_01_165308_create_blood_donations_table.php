...
class CreateBloodDonationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Blood_donations", 'blood_donations', 'recipient_name', 'fa-angle-double-right', [
            ["emp_id", "RAB ID", "Dropdown", false, "", 0, 0, true, "@employees_info"],
            ["donate_date", "Donate  Date", "Date", false, "", 0, 0, true],
            ["recipient_name", "Recipient ", "TextField", false, "", 0, 100, true],
            ["donate_location", "Location", "Textarea", false, "", 0, 0, false],
        ]);
