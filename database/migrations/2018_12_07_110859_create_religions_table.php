...
class CreateReligionsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Religions", 'religions', 'religion_name', 'fa-angle-double-right', [
            ["religion_name", "Name", "TextField", true, "", 0, 100, true],
            ["religion_bn_name", "Bangla Name", "TextField", true, "", 0, 100, true],
        ]);
