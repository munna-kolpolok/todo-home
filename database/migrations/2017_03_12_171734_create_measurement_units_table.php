...
class CreateMeasurementUnitsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Measurement_units", 'measurement_units', 'mm_unit_name', 'fa-angle-double-right', [
            ["mm_unit_name", "Unit Name", "String", true, "", 0, 100, true],
            ["mm_unit_code", "Unit Code", "String", false, "", 0, 10, false],
        ]);
