...
class CreateGendersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Genders", 'genders', 'gender_name', 'fa-angle-double-right', [
            ["gender_name", "Name", "TextField", true, "", 0, 100, true],
            ["gender_bn_name", "Bangla Name", "TextField", true, "", 0, 256, true],
        ]);
