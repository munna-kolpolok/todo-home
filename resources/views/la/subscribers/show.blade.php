	...
	<div class="bg-success clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $subscriber->$view_col }}</h4>					
				</div>
			</div>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-1 actions">
			@la_access("Subscribers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/subscribers/'.$subscriber->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Subscribers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.subscribers.destroy', $subscriber->id], 'method' => 'delete', 'style'=>'display:inline']) }}
