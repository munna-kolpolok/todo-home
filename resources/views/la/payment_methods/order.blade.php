...
@section("contentheader_description", "Payment Methods Order Listing")
@section("section", trans("messages.Payment Methods"))
@section("sub_section", trans("messages.Listing"))
@section("htmlheader_title", "Payment Methods Order Listing")
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered">
                ...
                @foreach($payments as $key=>$payment)
                    <tr class="row1" data-id="{{ $payment->id }}">
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('admin/payment_methods/payment-order-update') }}",
                data: {
                    order: order,
                    _token: '{{csrf_token()}}'
                },
