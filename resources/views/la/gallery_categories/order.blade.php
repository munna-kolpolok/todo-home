...
@section("contentheader_description", "Gallery Categories Order Listing")
@section("section", trans("messages.Gallery Categories"))
@section("sub_section", trans("messages.Listing"))
@section("htmlheader_title", "Gallery Categories Order Listing")
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered">
                ...
                @foreach($galleryCategories as $key=>$categorie)
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('admin/gallery_categories/gallery-categories-order-update') }}",
                data: {
                    order: order,
                    _token: '{{csrf_token()}}'
                },
