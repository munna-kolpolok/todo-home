...
@section("contentheader_description", "Press Categories Order Listing")
@section("section", trans("messages.Press Categories"))
@section("sub_section", trans("messages.Listing"))
@section("htmlheader_title", "Press Categories Order Listing")
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered">
                ...
                @foreach($pressCategories as $key=>$categorie)
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('admin/press_categories/press-categories-order-update') }}",
                data: {
                    order: order,
                    _token: '{{csrf_token()}}'
                },
