    ...
    @if(count($languages)>0)
        <div class="box box-success">
                ...
                <div id="payment-tab">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="locale" class="form-controll" id="" rel="select2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="whome_donate" class="form-control"
                                                  ...
                                                  placeholder="Enter Whome donate"></textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="why_donate" class="form-control"
                                                  id="why_donate" rows="3" placeholder="Enter Whome donate"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="how_donate" class="form-control"
                                                  id="how_donate" rows="3" placeholder="Enter How donate"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="intro_description" class="form-control"
                                                  ...
                                                  rows="3">{{old('intro_description')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="home_project_short_desc" class="form-control"
                                                  ...
                                                  rows="3">{{old('home_project_short_desc')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" name="home_work_short_desc" class="form-control"
                                                  ...
                                                  rows="1">{{old('home_work_short_desc')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                 Max Character 30 for better looking
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="work_food_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Work Food Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="work_edu_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Work Education Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="work_shelter_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Work Shelter Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="work_medical_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Work Medical Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="work_clothing_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Work Clothing Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea type="text" name="work_training_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Work Training Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 100 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="home_volunteer_message" class="form-control"
                                                   ...
                                                   value="{{old('home_volunteer_message')}}">
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" name="about_description" class="form-control"
                                                  ...
                                                  rows="3">{{old('about_description')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="about_who_we_are" class="form-control"
                                                  ...
                                                  placeholder="Enter About Who We Are Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="about_what_we_do" class="form-control"
                                                  ...
                                                  placeholder="Enter About What We Do Description"></textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 800 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mission_subtitle_down" class="form-control"
                                                   ...
                                                   value="{{old('mission_subtitle_down')}}">
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                 Max Character 30-50 for better looking
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" name="mission_description" class="form-control"
                                                  ...
                                                  rows="3">{{old('mission_description')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="mission_heading_1_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Heading 1 Description">{{old('mission_heading_1_desc')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 1000 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="mission_heading_2_desc" class="form-control"
                                                  ...
                                                  placeholder="Enter Heading 2 Description">{{old('mission_heading_2_desc')}}</textarea>
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                Max Character 1000 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vision_video_subtitle_up" class="form-control"
                                                   ...
                                                   value="{{old('vision_video_subtitle_up')}}">
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                 Max Character 60-80 for better looking
                                            </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vision_video_subtitle_down" class="form-control"
                                                   ...
                                                   value="{{old('vision_video_subtitle_down')}}">
                                            <span class="suggestion_text">
                                                <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                                 Max Character 30-50 for better looking
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="contact_address" class="form-control"
                                                  ...
                                                  placeholder="Enter Contact Address">{{old('contact_address')}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea type="text" name="receipt_body" class="form-control"
                                                  ...
                                                  placeholder="Enter Receipt Body">{{old('receipt_body')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group" style="text-align: center">
                            {!! Form::submit( Lang::get('messages.Save Translations'), ['class'=>'btn btn-success']) !!}
            ...
            @else
                <div class="box box-success">
                    <div class="box-body">
                        All Languages content are already entered. You can edit the contents from the list.
                    </div>
                </div>
            @endif
