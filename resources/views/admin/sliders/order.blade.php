...
@section("contentheader_description", "Sliders Order Listing")
@section("section", trans("messages.Slider"))
@section("sub_section", trans("messages.Listing"))
@section("htmlheader_title", "Sliders Order Listing")
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('admin/sliders/sliders-order-update') }}",
                data: {
                    order: order,
                    _token: '{{csrf_token()}}'
                },
