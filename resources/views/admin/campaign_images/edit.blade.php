...
@section("htmlheader_title", trans("messages.Edit Campaign Images"))
...
@section("main-content")
    ...
    <div class="box box-success">
        {!! Form::model($camapaign_images, ['route' => [config('laraadmin.adminRoute') . '.camapaign_images.update', $camapaign_images->id ],'method' =>'PUT','files' => true,'role'=>"form"]) !!}
            ...
            <div style="border: 1px solid #eeeeee; padding: 20px; margin: 10px 0;box-shadow: 0 0px 0 2px rgba(0,0,0,.2)"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="parent">@lang('messages.Campaigns')<span
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <select class="form-control" name="campaign_id" required>
                                    ...
                                    <option value="{{$val->id}}" {{$camapaign_images->campaign_id==$val->id? "selected":""}}>{{$val->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="image">@lang('messages.Campaign Image')<span
                                            class="la-required">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                @if(!is_null($camapaign_images->image))
                                    <img src="{{asset($camapaign_images->image)}}" alt="Image" width="200px"
                                         height="138px">
                                @else
