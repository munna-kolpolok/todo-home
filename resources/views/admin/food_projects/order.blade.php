...
@section("contentheader_description", "Food Project Order Listing")
@section("section", trans("messages.Food Projects"))
@section("sub_section", trans("messages.Listing"))
@section("htmlheader_title", "Food Project Order Listing")
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered">
                ...
                @foreach($foodProjects as $key=>$project)
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('admin/food_projects/food-projects-order-update') }}",
                data: {
                    order: order,
                    _token: '{{csrf_token()}}'
                },
