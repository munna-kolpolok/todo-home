...
@section("htmlheader_title", trans("messages.Edit Wedding Slider"))
...
@section("main-content")
    ...
    <div class="box box-success">
        {!! Form::model($wedding_sliders, ['route' => [config('laraadmin.adminRoute') . '.wedding_sliders.update', $wedding_sliders->id ],'method' =>'PUT','files' => true,'role'=>"form"]) !!}
        <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="10" maxlength="50" class="form-control title" name="title"
                                   placeholder="@lang('messages.Slider Title')" value="{{$wedding_sliders->title or null}}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="10" maxlength="50" required class="form-control bn_title"
                                   ...
                                   value="{{$wedding_sliders->bn_title or null}}">
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    Minimum 10 and Maximum 50 Character.
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="10" maxlength="100" class="form-control subtitle"
                                   ...
                                   value="{{$wedding_sliders->subtitle or null}}" required>
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="10" maxlength="100" required class="form-control bn_subtitle"
                                   ...
                                   value="{{$wedding_sliders->bn_subtitle or null}}">
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    Minimum 10 and Maximum 100 Character.
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_up" minlength="50" maxlength="400"
                                      ...
                                      placeholder="@lang('messages.Slider Up Description')">{{$wedding_sliders->description_up or null}}</textarea>
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control bn_description_up" required minlength="50" maxlength="400"
                                      ...
                                      name="bn_description_up">{{$wedding_sliders->bn_description_up or null}}</textarea>
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    Minimum 50 and Maximum 400 Character.
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control description_down" minlength="50" maxlength="400"
                                      ...
                                      placeholder="@lang('messages.Slider Down Description')">{{$wedding_sliders->description_down or null}}</textarea>
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    Minimum 50 and Maximum 400 Character.
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control bn_description_down" required minlength="50" maxlength="400"
                                      ...
                                      name="bn_description_down">{{$wedding_sliders->bn_description_down or null}}</textarea>
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                                    Minimum 50 and Maximum 400 Character.
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control button_label"  maxlength="25" name="button_label" required
                                   placeholder="@lang('messages.Button Label')" value="{{$wedding_sliders->button_label or null}}">
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control bn_button_label" required maxlength="15"
                                   ...
                                   name="bn_button_label" value="{{$wedding_sliders->bn_button_label or null}}">
                            <span class="suggestion_text">
                                    <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control button_link" name="button_link" required
                                   placeholder="@lang('messages.Button Link')" value="{{$wedding_sliders->button_link or null}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control type" name="button_color" >
                                ...
                                <option value="2" {{$wedding_sliders->button_color==2 ? "selected":"" }}>Theme Color</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control type" name="is_show" >
                                ...
                                <option value="2" {{$wedding_sliders->is_show==2? "selected":"" }}>Not show in website</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div style="margin-top: 0" class="media">
                                <div class="media-body slider_image">
                                    <input type="file" id="photo-add" class="form-control image" name="image" accept="image/jpeg,image/jpg">
                    ...
                    <div class="col-md-2">
                        <div id="image-preview">
                            <img src="{{asset($wedding_sliders->image)}}" alt="image" class="single-image">
                        </div>
                    </div>
                </div>
