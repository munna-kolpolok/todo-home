...
@section("contentheader_description", "Wedding Sliders Order Listing")
@section("section", trans("messages.Wedding Slider"))
@section("sub_section", trans("messages.Listing"))
@section("htmlheader_title", "Wedding Sliders Order Listing")
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ url('admin/wedding_sliders/sliders-order-update') }}",
                data: {
                    order: order,
                    _token: '{{csrf_token()}}'
                },
