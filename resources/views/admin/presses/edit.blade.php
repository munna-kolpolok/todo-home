        ...
        <div class="box-body">
            <div style="border: 1px solid #eeeeee; padding: 20px; margin: 10px 0;box-shadow: 0 0px 0 2px rgba(0,0,0,.2)"
                        ...
                        <div class="form-group">
                            <select class="form-control press-category" name="press_category_id" id="pressRow" required>
                                @foreach($categories as $val)
                                    <option value="{{$val->id}}" {{$presses->press_category_id==$val->id? "selected":""}}>{{$val->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <textarea name="description" class="form-control description" rows="5"
                                      ...
                                      required>{{$presses->description or null}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <textarea name="bn_description" class="form-control bn_description"
                                      placeholder="Enter description in Bangla" rows="5"
                                      required>{{$presses->bn_description or null}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
