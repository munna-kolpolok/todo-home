                ...
                <div style="border: 1px solid gray; padding: 20px; margin: 10px 0" class="gallery_wrapper">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="form-group">
                                    <select class="form-control websiteRow" name="website[]"  id="websiteRow_1" onchange="get_Cat(this.id,this.value)">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="form-control gallery-category CatRow" name="gallery_category_id[]" id="CatRow_1"  required>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#add-row').on('click', function (e) {
            ...
            /*select dependend droup down newly added by shamim*/
            /*var newOptions = {
             "Bidyanondo": 1,
             "One Taka Ahar": 2,
             };*/
        ...
        $.ajax({
            ...
            success: function (data) {
               // alert(data); return;
                ...
                var $cat_dropdown = $("#CatRow_"+currnt_row_no);
