            ...
            <div style="border: 1px solid #eeeeee; padding: 20px; margin: 10px 0;box-shadow: 0 0px 0 2px rgba(0,0,0,.2)"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <select class="form-control gallery-category" name="gallery_category_id" id="CatRow"    required>
                                    ...
                                    <option value="{{$val->id}}" {{$galleries->gallery_category_id==$val->id? "selected":""}}>{{$val->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="image">@lang('messages.Gallery Image')<span
                                            class="la-required">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                @if(!is_null($galleries->gallery_image))
                                    <img src="{{asset($galleries->gallery_image)}}" alt="Image" width="200px"
                                         height="138px">
                                @else
                                    <img src="{{asset('uploads/students/default/default.png')}}" alt="No Image"
