		...
		<div class="row upper-footer">
			<div class="col col-md-5 col-xs-6">
				<div class="widget about-widget">
					...
					<div class="details">
						<a href="{{url('about')}}">
							<p class="text-justify">{{str_limit($setting->bn_about_short_brief,220)}}</p>
			...
			<div class="col col-md-3 col-xs-6">
				<div class="widget contact-widget">
					...
					<div>
						<p ><strong><i class="fa fa-map-marker fa-2" aria-hidden="true"></i> :</strong> {{ $setting->bn_contact_address or null}}</p>
						<p ><table>
							<tr style="color:#A9B0BE ;">
								<td style=" min-width:85px;"><strong><i class="fa fa-phone" style="padding-right: 5px;"></i> : </strong> {{ $setting->bn_contact_no or null}}</td>
							</tr>
							{{--<tr style="color:#A9B0BE;">
