    ...
    <nav class="navigation navbar navbar-default navbar-fixed-top" id="main-navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand wow fadeInLeftSlow" href="{{url('/')}}"><img src="{{asset($setting->logo)}}"
                                                                                    alt=""></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="sub-menu">
                        <a href="#" data-toggle="modal"
                           data-target="#donate-simple-modal">@lang('messages.Donations')</a>
                        <ul>
                            <li><a href="#" data-toggle="modal"
                                   data-target="#donate-simple-modal">@lang('messages.Donate Now')</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul>
                            @foreach($projects as $project)
                                <li>
                                    @if($project->id=='1')
                                    <a href="http://onetakameal.org" target="_blank">{{ $project->name or null}}</a>
                                    @else
                                    <a href="{{ url('projects/'.str_replace(' ', '-', $project->name)) }}">{{ $project->name or null}}</a>
                                    @endif
                                </li>
                            @endforeach
                        </ul>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('campaigns') }}">@lang('messages.Our Campaigns')</a></li>
                            <li><a href="{{ url('branch') }}">@lang('messages.Branch')</a></li>
                        ...
                        <li class="sub-menu">
                            @if(Auth::user()->user_level>'1')
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('/forget-password') }}">@lang('messages.Forgot Password')</a>
                                    </li>
                            ...
                            @else
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ url('/donors') }}">Hello, {{ str_limit(Auth::user()->name, $limit = 15, $end = '...') }}</a>
                                    </li>
                                    <li><a href="{{ url('/reset-password') }}">@lang('messages.Reset Password')</a></li>
                                    <li><a href="{{ url('/forget-password') }}">@lang('messages.Forgot Password')</a>
                                    </li>
