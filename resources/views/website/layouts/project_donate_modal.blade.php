                                                ...
                                                <div class="amount">
                                                    <form method="POST"
                                                        ...
                                                        <div class="row option-wrapper-in">
                                                            <div id="project-payment-option-in">
                                                            </div>
                                                    ...
                                                    <div class="amount">
                                                        <form method="POST"
                                                            ...
                                                            <div class="row option-wrapper-bd">
                                                                <div id="project-payment-option-bd">
                                                                    ...
                                                                    <label class="radio-inline">
                                                                        ...
                                                                        <input name="amount" checked
                                                                               ...
                                                                               type="radio" class="usd_radio_general"  onclick="usd_general_load()"/><span
                                                                                class="in-currency">USD</span> {{number_format(ceil($donation_amount->amount/$currency_usd->tk_convert_amount))}} {{$donation_amount->description or null}}
                                                                        ...
                                                                        <label class="radio-inline">
                                                                            <input name="amount" checked
                                                                                   ...
                                                                                   type="radio"  class="bdt_radio_general"  onclick="bdt_general_load()"/><span
                                                                                    class="bd-currency">৳</span> {{\App\Helpers\CommonHelper::bd_money_format_wod($donation_amount->amount)}} {{$donation_amount->description or null}}
                                                                        </label>
                                                                    </div>
                                                                @endforeach
...
<script>
    ...
    {
        $("#custom_bdt_general").attr("placeholder", "<?php echo Lang::get('messages.Minimum donation amount is')?> "+min_amount+ " <?php echo Lang::get('messages.Taka')?>");
    ...
    {
        $("#custom_usd_general").attr("placeholder", "<?php echo Lang::get('messages.Minimum donation amount is')?> "+min_amount+ " <?php echo Lang::get('messages.Dollar')?>");
    ...
    {
        $("#custom_bdt_project").attr("placeholder", "<?php echo Lang::get('messages.Minimum donation amount is')?> "+min_amount+ " <?php echo Lang::get('messages.Taka')?>");
    ...
    {
        $("#custom_usd_project").attr("placeholder", "<?php echo Lang::get('messages.Minimum donation amount is')?> "+min_amount+ " <?php echo Lang::get('messages.Dollar')?>");
