            ...
            <div class="row">
                <div class="col col-md-6">
                    <div class="help-item wow slideInUpSlow">
                        ...
                        <div class="details">
                            <a href="#" data-toggle="modal"
                               data-target="#donate-simple-modal"><h3>{{ $setting->bn_cta_title_1 or null}}</h3></a>
                    ...
                    <div class="help-item wow slideInUpSlow" data-wow-delay="0.3s">
                        ...
                        <div class="details">
                            <a href="{{ url('volunteer/registration') }}"><h3>{{ $setting->bn_cta_title_2 or null}}</h3>
                            </a>
                    ...
                    <div class="help-item wow slideInUpSlow" data-wow-delay="0.6s">
                        ...
                        <div class="details">
                            <a href="{{ url('sponsor') }}"><h3>{{ $setting->bn_cta_title_3 or null}}</h3>
                            </a>
                                ...
                                <div class="event-box">
                                    ...
                                    <div class="event-details">
                                        ...
                                        <h3 style="margin-top: 0; margin-bottom: 10px"><a
                                                    href="{{ url('projects/'.$project->id) }}">{{ $project->bn_name or null }}</a>
                                        </h3>
            ...
            <div class="row">
                ...
                <div class="col col-md-6 col-md-offset-1 col-sm-7">
                    <div class="cta-details wow fadeInRightSlow">
                        <h2>{{ $setting->bn_cover_project_name or null }}</h2>
                        <p>{{ $setting->bn_cover_project_desc or null }}</p>
                        <a href="#" class="btn theme-btn" data-toggle="modal"
                           data-target="#donate-simple-modal">@lang('messages.Donate')</a>
                    </div>
                </div>
                        ...
                        <div class="box">
                            <div class="img-holder-donation">
                                ...
                                <div class="donation-box">
                                    <div>
                                        <p class="dollar">{{\App\Helpers\CommonHelper::en2bnNumber($campaign->images_count)}}</p>
                            ...
                            <div class="details">
                                <h3>
                                    <a href="{{url('/campaign/details/'.$campaign->id)}}">{{$campaign->bn_title or null}}</a>
                                </h3>
                                <p>
                                    <i class="fa fa-clock-o">
                                        {{\App\Helpers\CommonHelper::en2bnNumber(date('d',strtotime($campaign->date)))}}
                                        {{\App\Helpers\CommonHelper::en2bnNumber(date('M',strtotime($campaign->date)))}},
                                        {{\App\Helpers\CommonHelper::en2bnNumber(date('Y',strtotime($campaign->date)))}}
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col col-md-7 col-sm-8 sing-up  wow fadeInRightSlow">
                    ...
                    <p>{{ $setting->bn_home_volunteer_desc or null}}</p>
                    <a href="{{ url('volunteer/registration') }}"
                       class="btn theme-btn">@lang('messages.Registration')</a>
                </div>
            </div> <!-- end row -->
        ...
        <div class="container">
            <div class="row section-title-s2">
                <div class="col col-md-8 col-md-offset-2">
                    ...
                    <p>{{ $setting->bn_home_mission_desc or null }}</p>
                </div>
            </div> <!-- end section-title -->
            ...
            <div class="row content">
                <div class="col col-md-4">
                    <div class="wow fadeInLeftSlow" style="background:#ed3237">
                        ...
                        <p>{{ $setting->bn_home_mission_food or null }}</p>
                    </div>
                </div>
                <div class="col col-md-4">
                    <div class="wow fadeInLeftSlow" style="background:#ed3237" data-wow-delay="0.5s">
                        ...
                        <p>{{ $setting->bn_home_mission_education or null }}</p>
                    </div>
                </div>
                <div class="col col-md-4">
                    <div class="wow fadeInLeftSlow" style="background:#ed3237" data-wow-delay="1s">
                        ...
                        <p>{{ $setting->bn_home_mission_treatment or null }}</p>
                    </div>
                </div>
            </div> <!-- end row -->
        </div> <!-- end container -->
