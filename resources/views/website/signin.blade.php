        ...
        <div class="container">
            ...
            <div class="signin-content wow slideInDown">
                <div class="signin-image">
                    ...
                    <a href="{{ url('signup') }}" data-toggle="tooltip"
                       title="@lang('messages.Click here and create new account!')"
                       class="signup-image-link">@lang('messages.Create an account')</a>
                </div>

                <div class="signin-form wow slideInRight">
                    <h2 class="form-title">@lang('messages.Sign in')</h2>
                    <form method="POST" class="register-form" id="login-form" action="{{ url('/login') }}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group">
                            <label for="your_name"><i class="zmdi zmdi-email"></i></label>
                            <input type="email" name="email" id="email" placeholder="@lang('messages.Enter Your Email')"
                                   required="1"/>
                        </div>
                        <div class="form-group">
                            <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                            <input type="password" name="password" id="password"
                                   placeholder="@lang('messages.Enter Password')" required="1"/>
                        </div>

                        <div class="form-group">
                            <input type="checkbox" name="remember" id="agree-term" class="agree-term"/>
                            <label for="agree-term" class="label-agree-term"><span></span>@lang('messages.Remember me')
                            </label>
                        </div>
                            ...
                            <div class="col-md-5">
                                <div class="social-login-wrapper">
                                    <button type="button" class="google-button btn-block">
                                        ...
                                        <a class="google-button__text" href="{{url('/redirect/google')}}">@lang('messages.Sign in with Google')</a>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <a style="display: inline;" href="{{ url('forget-password') }}"
                                   class="signup-image-link">@lang('messages.Forgot Password')</a>
                            </div>
                        </div>
                    </form>
                    {{--  <div class="social-login">
                          ...
                          <ul class="socials">
                             --}}{{-- <li><a href="#"><i class="display-flex-center zmdi zmdi-facebook"></i></a></li>--}}{{--
                              ...
                              <li><a href="{{url('/redirect/google')}}"><i class="display-flex-center zmdi zmdi-google"></i></a></li>
                          </ul>
                      </div>--}}
                </div>
            </div>
