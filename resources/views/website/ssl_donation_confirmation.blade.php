...
<div class="container-fluid">
    ...
    <div class="row  donation-top-bar" style="border-bottom: 2px solid #0094D6;">
        <div class="col-lg-6 col-md-3 col-sm-3 header-logo">
            <a href="{{ URL::previous() }}"><img class="donation-confirm-logo" src="{{ asset('site-assets/images/bidyanondo-logo-sm.jpg') }}"
                 alt="Bidyanondo"></a>
            
        </div>
        <div class="col-lg-6 col-md-9 col-sm-9 header-text" style="">
            <p class="donation-confirm-top-tex">Having Problems? Call Support: <strong class="contact-no">{{$setting->contact_no }} </strong></p>
        </div>
    </div>
