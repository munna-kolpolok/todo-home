                            ...
                            <div class="col-md-8 py-5 col-centered">
                                ...
                                <div class="" id="tab-cont">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs2 tab-title" style="">
                                        <li class="@if(  old('volunteer') !=2) active @endif" style="width: 50%"><a data-toggle="tab"  href="#local" id="local_nav">@lang('messages.Local')</a>
                                        </li>
                                        <li class="nav-item @if(  old('volunteer') ==2) in active @endif " style="width: 50%">
                                    ...
                                    <div class="tab-content">
                                        <div id="local" class="tab-pane fade @if(  old('volunteer') !=2) in  active @endif">
                                                    ...
                                                    <div class="form-row" id="">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" required class="form-control first_name"
                                                                   ...
                                                                   value="{{old('volunteer') !=2? old('first_name'):""}}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="last_name"
                                                                   ...
                                                                   value="{{old('volunteer') !=2? old('last_name'):""}}" required>
                                                    ...
                                                    <div class="form-row" id="">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="email" required class="form-control email"
                                                                   ...
                                                                   value="{{old('volunteer') !=2? old('email'):""}}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" required class="form-control contact_no"
                                                                   ...
                                                                   value="{{old('volunteer') !=2? old('contact_no'):""}}">
                                                        </div>
                                                    </div>
                                                    {{--for bengali--}}
                                        ...
                                        <div id="international" class="tab-pane fade @if(  old('volunteer') ==2) in active @endif">
                                            <div id="donation-form">
                                                {{-- <p style="color: #ff0000db">Please, fill up all information for
                                                     registration.</p>--}}
                                                <br>
                                                    ...
                                                    <div class="form-row" id="">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" required class="form-control first_name"
                                                                   ...
                                                                   id="first_name"
                                                                   placeholder="@lang("messages.Enter your first name")"
                                                                   value="{{old('volunteer') !=1? old('first_name'):""}}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="last_name"
                                                                   id="last_name"
                                                                   placeholder="@lang('messages.Enter your last name')"
                                                                   value="{{old('volunteer') !=1? old('last_name'):""}}" required>
                                                    ...
                                                    <div class="form-row" id="">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="email" required class="form-control email"
                                                                   ...
                                                                   id="email"
                                                                   placeholder="@lang("messages.Enter Your Email")"
                                                                   value="{{old('volunteer') !=1? old('email'):""}}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" required class="form-control contact_no"
                                                                   ...
                                                                   id="contact_no"
                                                                   placeholder="@lang("messages.Enter Contact No")"
                                                                   value="{{old('volunteer') !=1? old('contact_no'):""}}">
