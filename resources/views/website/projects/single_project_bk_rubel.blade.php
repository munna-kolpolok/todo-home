    ...
    <section style="padding: 125px 0 35px 0; background: none" class="about-us-st" id="donate">
        <div class="container">
            ...
            <div class="row flex-div" >
                <div style="padding: 0;   background: url('{{asset($project->project_big_image)}}'); background-repeat: no-repeat; background-position: center; background-size: cover"  class="col col-md-4 col-xs-12 wow fadeInRightSlow">
                                                ...
                                                <div class="row option-wrapper-in">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <label class="radio-inline" style="display: block">
                                                            <input name="amount" id="general_in_single_project" value=""
                                                                   type="radio"/>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div class="row option-wrapper-bd">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <label class="radio-inline" style="display: block">
                                                                <input name="amount" id="general_bd_single_project"
                                                                       type="radio"/>
