                           ...
                           <div class="post-content">
                               ...
                               <div class="panel panel-default">
                                   <div class="panel-heading">
                                       <h3 class="panel-title">{{ $inbox->created_at }}</h3>
                                       ...
                                       <div class="post-content-inner">
                                           <div class="post-content-inner-left">
                                               <ul class="list-group">
                                                   ...
                                                   <li class="list-group-item"><span class="post-field-title">Sector :</span> {{ $inbox->sector->name or null}}</li>
                                                            ...
                                                            <div class="media">
                                                               <div class="media-body">
                                                                   ...
                                                                   @if($inbox_chat->is_file==1)
                                                                    <a href="{{ url($inbox_chat->comments)}}"><i class="fa fa-download" aria-hidden="true"></i> Attachment</a>
                                                                   @else
                                                                    <pre>{{ $inbox_chat->comments or null }}</pre>
                                                                   @endif
                                                               </div>
