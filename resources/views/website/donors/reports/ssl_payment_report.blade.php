                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div style="width: 100%" class="breadcomb-ctn">
                                    <h2 style="line-height: 48px; color: #21c292">Donation List of BDT in {{ $current_year }}</h2>
                                        ...
                                        <table class="col-md-12 table-bordered table-striped table-condensed cf">
                                            ...
                                            <tbody>
                                              <?php $total_sum=0;?>
                                                ...
                                                <tr>
                                                    <td data-title="Date">{{$value->tran_time}}</td>
                                                    <td data-title="currency">{{$value->currency}}</td>
                                                    <td data-title="amount" align="right">{{$value->total_amount}}</td>
                                                </tr>
                                                <?php $total_sum+=$value->total_amount;?>
                                                @endforeach
