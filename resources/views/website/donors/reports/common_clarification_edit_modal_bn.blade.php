            ...
            <div class="modal-body">
                <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="email">@lang("messages.Payment Channel")<span
                                            class="la-required"> * </span>:</label>
                                <select class="form-control select2_edit" name="payment_method_id" id="payment_method_id"
                    ...
                    <div class="row account_div">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="email" id="l_payer_account_no_e">@lang("messages.Donor Bkash No")<span class="la-required"> * </span>:</label>
                                <input type="text" class="form-control" name="payer_account_no" id="payer_account"
                                       placeholder="@lang('messages.Enter Donor Information')" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="payee_account_no" id="payee_account"
                                       placeholder="@lang('messages.Enter Recipient Information')" required
                                       value="{{ old('payer_account_no') }}">
                            </div>
                        </div>
