                            ...
                            <div class="col col-md-12">
                                <div class="student-biography">
                                    ...
                                    <div class="student-biography-inner">
                                        ...
                                        <p><img src="{{asset($student->student_image)}}" alt="{{$student->bn_name}}" align="left"> {{$student->bn_biography or null}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <table class="col-md-12 table-bordered table-striped table-condensed cf">
                                                            ...
                                                            @foreach($student->details as $key => $detail)
                                                                <tr>
                                                                    ...
                                                                    <td data-title="topic">{{$detail->bn_topic or null}}</td>
                                                                    <td data-title="Date">{{\App\Helpers\CommonHelper::en2bnNumber($detail->date)}}</td>
                                                                    <td data-title="Description">
                                                                        {{$detail->bn_description or null}}
                                                                    </td>
                                                    ...
                                                    <div class="col-md-4">
                                                        <ul class="additional-info">
                                                            <li>
                                                                ...
                                                                {{$student->bn_father_name or null}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                                <span class="info-title">
                                                                ...
                                                                {{$student->bn_father_occupation or null}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                    ...
                                                    <div class="col-md-4">
                                                        <ul class="additional-info">
                                                            <li>
                                                                ...
                                                                {{$student->bn_mother_name or null}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                                <span class="info-title">
                                                                ...
                                                                {{$student->bn_mother_occupation or null}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                            ...
                                                            <li>
                                                                ...
                                                                {{\App\Helpers\CommonHelper::en2bnNumber($student->height)}}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <ul class="additional-info">
                                                            <li>
                                                                ...
                                                                {{$student->religion->religion_bn_name or null}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                                <span class="info-title">
                                                                ...
                                                                {{$student->gender->gender_bn_name or null}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                                <span class="info-title">
                                                                ...
                                                                {{\App\Helpers\CommonHelper::en2bnNumber($student->weight)}}
                                                            </li>
                                                            <li>
                                                                <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                                                                <span class="info-title">
