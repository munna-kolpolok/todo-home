...
<section class="page-title">
    ...
    <div class="container">
        <div class="title-box">
            <h1><span class="title-custom-color">@lang('messages.About')</span> @lang('messages.us')</h1>
            <ol class="breadcrumb">
...
<!-- start about-details -->
<section style="padding: 80px 0" class="about-us-st">
    <div class="container">
        ...
        <div class="row">
            <div class="col col-md-6">
                <div class="left-col">
                    <div class="company">
                        <h3>{{ $setting->about_title or null}}</h3>
                        <span>{{ $setting->about_sub_title or null}}</span>
                    </div>
                    <p class="text-justify">{{ $setting->about_short_brief or null}}</p>
                    {{--Panel--}}
                </div> <!-- end left-col -->
            </div> <!-- end col -->
                    ...
                    <div class="panel panel-default current">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <div class="details">
                                    <p class="text-justify"><strong>@lang('messages.Vision'):</strong> {{ $setting->vission or null}}
                                    </p>
                                    <p class="text-justify"><strong>@lang('messages.Mission'):</strong> {{ $setting->mission or null}}
                                    </p>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <div class="details">
                                    <p class="text-justify">{{ $setting->where_we_work or null}}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <div class="details">
                                    <p class="text-justify">{{ $setting->our_story or null}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
